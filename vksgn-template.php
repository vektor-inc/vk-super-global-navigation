...
?>">
	...
	<ul class="vksgn-primary">
		<li class="vksgn-primary-item product">
			<span><i class="fa-solid fa-rocket"></i>今すぐ開始</span>
			<div class="vksgn-sub">
				...
				<div class="vksgn-sub-title"><a href="https://vk-fullsite-installer.com/site/">実例を見る<i class="fa-solid fa-chevron-right"></i></a></div>
			</div>
		</li>
		<li class="vksgn-primary-item product">
			<span><i class="fa-solid fa-fire"></i>人気の製品</span>
			<div class="vksgn-sub">
				<ul class="vksgn-sub-items">
				...
				<div class="vksgn-sub-title"><a href="https://www.vektor-inc.co.jp/service/products/ ">製品一覧<i class="fa-solid fa-chevron-right"></i></a></div>
			</div>
		</li>
		<li class="vksgn-primary-item know">
			<span><i class="fa-solid fa-desktop"></i>知る・学ぶ</span>
			<div class="vksgn-sub">
				<ul class="vksgn-sub-items">
		...
		<li class="vksgn-primary-item join">
			<span><i class="fa-solid fa-users"></i>参加する</span>
			<div class="vksgn-sub">
				<ul class="vksgn-sub-items">
					<li class="vksgn-sub-item"><a href="https://vektor.connpass.com/" target="_blank"><i class="fa-solid fa-chalkboard-teacher"></i>勉強会・<br>質問相談会</a></li>
					<li class="vksgn-sub-item"><a href="https://vws.vektor-inc.co.jp/vws-community"><i class="fa-brands fa-discord"></i>VWS<br>
					ユーザーDiscord</a></li>
					<li class="vksgn-sub-item"><a href="https://vws.vektor-inc.co.jp/forums"><i class="fa-regular fa-comments"></i>VWS<br>
					フォーラム</a></li>
				</ul>
				<div class="vksgn-sub-title"><a href="https://vws.vektor-inc.co.jp/vws-community"> オンラインコミュニティ一覧<i class="fa-solid fa-chevron-right"></i></a></div>
			</div>
		</li>
		<li class="vksgn-primary-item"><a href="https://vws.vektor-inc.co.jp/"><i class="fa-solid fa-shopping-cart"></i>購入する</a></li>
	</ul>
</div>